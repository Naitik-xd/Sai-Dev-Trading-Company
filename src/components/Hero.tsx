      ...
      <div className="container relative z-20 mx-auto px-6 md:px-12 flex flex-col items-center text-center mt-12 md:mt-0">
        ...
        >
          ...
          <a
            ...
            className="w-full sm:w-auto bg-[#FFD700] text-[#0A1628] hover:bg-[#FFC000] hover:shadow-[0_0_20px_rgba(255,215,0,0.5)] transition-all duration-300 px-8 py-4 flex items-center justify-center space-x-3 group active:scale-95"
          >
            <Mail size={18} />
